...
execute if score #duel duel_partie_va_commencer matches 1 run title @a[distance=..500] title {"text":"1","color":"green"}
...
execute if score #duel duel_partie_va_commencer matches 1 run schedule function world_event:duel/start/start 1s