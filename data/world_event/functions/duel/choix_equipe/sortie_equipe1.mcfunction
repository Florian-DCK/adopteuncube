#Débloquage du TP
execute as @e[tag=duel,type=armor_stand] at @s run setblock ~-30 ~1 ~28 air
execute as @e[tag=duel,type=armor_stand] at @s run setblock ~-30 ~2 ~28 air

#Retirer le tag, les items et TP le joueur
playsound minecraft:block.note_block.chime master @a[tag=duel_p1] ~ ~ ~ 100 0.5
title @a[tag=duel_p1] title {"text":"\u2694 Tu es sorti de l'arène ! \u2694","color":"gold"}
execute as @e[tag=duel,type=armor_stand] at @s run tp @a[tag=duel_p1] ~-25 ~1 ~25 90 0.45
clear @a[tag=duel_p1]
