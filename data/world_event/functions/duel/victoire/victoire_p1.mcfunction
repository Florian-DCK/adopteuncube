tellraw @a[distance=..100] ["",{"text":"Victoire du joueur 1 ","color":"gold"},{"text":" !","color":"gold"}]

#Son aux joueurs
    #Gagnant
    playsound entity.firework_rocket.launch master @a[tag=duel_p1] ~ ~ ~ 100 0.5

    #Perdant
    playsound block.nether_bricks.break master @a[tag=duel_p2] ~ ~ ~ 100 0.5
