...
execute if score #battle_egg battle_egg_partie_va_commencer matches 1 run title @a[distance=..500] title {"text":"2","color":"green"}
...
execute if score #battle_egg battle_egg_partie_va_commencer matches 1 run schedule function world_event:battle_egg/compteur/1 1s