#affichage de la victoire des bleus
execute as @e[tag=battle_egg] at @s run title @a[distance=..100] subtitle {"text":"Bravo à eux !","color":"gold"}
execute as @e[tag=battle_egg] at @s run title @a[distance=..100] title ["",{"text":"Les ","color":"gold"},{"text":"bleus","color":"dark_blue"},{"text":" ont gagnés !","color":"gold"}]
