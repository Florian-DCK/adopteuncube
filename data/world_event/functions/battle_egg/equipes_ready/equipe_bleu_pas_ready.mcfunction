...
execute if score #battle_egg battle_egg_jeu_en_cours matches 0 run tellraw @a[distance=..20] {"text":"Les bleus ont changés d'avis ...","bold":true,"underlined":true,"color":"gold"}
...
execute if score #battle_egg battle_egg_jeu_en_cours matches 0 run fill ~3 ~2 ~3 ~-3 ~2 ~-3 structure_void replace blue_stained_glass
